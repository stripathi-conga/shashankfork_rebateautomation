...
public class URLGenerator {
	...
	public String getDataSourceViaIdURL = "/query/?q=SELECT Id,Name FROM DataSource__c WHERE id = '{DataSourceId}'";
	public String getDataSourceViaLineObjectNameURL = "/query/?q=SELECT Id,Name FROM DataSource__c WHERE TransactionLineObjectName__c = '{TransactionLineObjectName}'";
	...
	public URLGenerator(String instanceURL) {
		...
		this.getDataSourceViaIdURL = baseURL + this.getDataSourceViaIdURL;
		this.getDataSourceViaLineObjectNameURL = baseURL + this.getDataSourceViaLineObjectNameURL;
