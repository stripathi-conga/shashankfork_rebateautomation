...
public class URLGenerator {
	...
	public String getParticipantsURL = "/query/?q=SELECT Id,AccountNumber__c,ExpirationDate__c,Name,Account__c,EffectiveDate__c from IncentiveParticipant__C where id='{participantId}'";
