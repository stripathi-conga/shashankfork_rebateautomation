...
public class DataHelper {
	...
	private static DataHelper instanceOfDataHelper=null;
	...
	synchronized public static DataHelper getInstanceOfDataHelper() {
		if(instanceOfDataHelper==null){
        	instanceOfDataHelper = new DataHelper();
        	createDataFlag = true;
        }
		return instanceOfDataHelper;
	}
